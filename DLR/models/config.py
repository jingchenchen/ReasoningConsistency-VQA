...
__C.EXP_NAME = 'DLR'
__C.GPUS = '0'
__C.SNAPSHOT_FILE = './exp/pytorch_ckpt/%s/%04d.ckpt'
__C.VOCAB_QUESTION_FILE = './exp/data/vocabulary.txt'
__C.VOCAB_ANSWER_FILE = './exp/data/answers.txt'
__C.IMDB_FILE = './exp/dataset/questions/%s_questions.json'
__C.OBJECTS_FEATURE_DIR = './exp/dataset/features'
__C.FEAT_TYPE = 'objects'
__C.INIT_WRD_EMB_FROM_FILE = True
__C.WRD_EMB_INIT_FILE = './exp/data/gloves_no_pad.npy'

# --------------------------------------------------------------------------- #
# model options
# --------------------------------------------------------------------------- #
__C.H_FEAT = 1
__C.W_FEAT = 50  # the maximum number of objects
__C.D_FEAT = 2144  # 2048+96
__C.T_ENCODER = 30
...
__C.TEST.RESULT_DIR = './exp/results/%s/%04d'
...
__C.TEST.EVAL_ID = '000'

# --------------------------------------------------------------------------- #
# Dialog-like Reasoning options
# --------------------------------------------------------------------------- #
...
__C.subset = 'all'
__C.dialog = False
__C.dialog_test = False
__C.loss_sub = True
__C.loss_sub_w = 0.05
__C.loss_con = True
__C.loss_con_w = 0.01
__C.loss_con_start = False
__C.loss_con_start_epoch = 5
